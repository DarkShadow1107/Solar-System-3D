define(["Environment/Constants", "Modules/Clock"], function (Constants, Clock) {
	"use strict";
	...
	class OrbitController {
		constructor(object, rotationEnabled) {
			...
			this._currentDay = 1;
			this._orbitAmplitude = this._object.threeParent
				? this._object.threeParent.threeRadius + this._distanceFromParent
				: 1000;
