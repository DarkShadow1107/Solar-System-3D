define(["Environment/Constants", "Models/CelestialObject", "Models/Orbit"], function (Constants, CelestialObject, Orbit) {
	"use strict";
	...
	class Moon extends CelestialObject {
		...
		buildFullObject3D() {
			...
			this._orbitCentroid.add(this._threeObject, this._core, this._orbitLine.orbit);
		}
