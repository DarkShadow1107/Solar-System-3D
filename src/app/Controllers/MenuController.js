define([
	...
	"Models/Planet",
	"Models/Moon",
], function ($, _, Backbone, TravelController, MoonMenuController, TemplateLoader, Planet, Moon, MoonData) {
	"use strict";
	...
	return Backbone.View.extend({
		...
		travelToObject: function (target) {
			...
			this.travelController.travelToObject(this.scene.camera.parent.position, target, target.threeDiameter * 2.5);
